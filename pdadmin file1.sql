...
--Q2. Which customers used a discount but still spent more than a average purchase amount?
...
round(sum(case when discount_applied = 'Yes' then 100.0 else 0 end)/count(*),2) as discount_rate
from customer
group by item_purchased
